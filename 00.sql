...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 16, 2020 at 09:14 AM
...
('JAB002', 'Manager'),
('JAB003', 'Supervisor'),
('JAB004', 'Staff Rumah Tangga'),
('JAB005', 'Coordinator'),
('JAB007', 'Manager Medis'),
('JAB008', 'Security'),
('JAB009', 'IT Staff'),
('JAB010', 'Manager Keuangan'),
('JAB011', 'Wakil Direktur'),
('JAB012', 'Staff Kebersihan'),
('JAB013', 'HRD'),
('JAB014', 'HRD Manager');
...
('SK/ZT/10/15/00003', '11251100759', '2010-01-02', 'JAB001', 'LOK001', 'PKT012', 'UKJ12', 'nonaktif'),
...
('USR001', 'abdan', 'abdan', 'Abdan Baihaqqi', '081299781928', 'admin', 'N'),
('USR006', 'adinda', 'dhiahrd', 'Adinda Permata Fani', '+6282113187668', 'hrd', 'N'),
('USR007', 'syarif', 'dhiapimpinan', 'Zulfikar Syarif', '+628111330014', 'gm', 'N');
...
--
ALTER TABLE `hukuman`
 ADD PRIMARY KEY (`id_hukuman`), ADD KEY `nik` (`nip`), ADD KEY `nip` (`nip`);

--
-- Indexes for table `jabatan`
--
ALTER TABLE `jabatan`
 ADD PRIMARY KEY (`id_jabatan`), ADD KEY `id_jabatan` (`id_jabatan`);
...
ALTER TABLE `lokasi_krj`
 ADD PRIMARY KEY (`id_lokasi`), ADD KEY `id_lokasi` (`id_lokasi`), ADD KEY `id_lokasi_2` (`id_lokasi`);
...
--
ALTER TABLE `pangkat`
 ADD PRIMARY KEY (`id_pangkat`), ADD KEY `id_pangkat` (`id_pangkat`);

--
-- Indexes for table `pegawai`
--
ALTER TABLE `pegawai`
 ADD PRIMARY KEY (`nip`), ADD KEY `nip` (`nip`), ADD KEY `nip_2` (`nip`);

--
-- Indexes for table `pendidikan`
--
ALTER TABLE `pendidikan`
 ADD PRIMARY KEY (`id_pend`), ADD KEY `nip` (`nip`), ADD KEY `nip_2` (`nip`);

--
-- Indexes for table `pengalaman_krj`
--
ALTER TABLE `pengalaman_krj`
 ADD PRIMARY KEY (`id_peng_krj`), ADD KEY `nip` (`nip`), ADD KEY `nip_2` (`nip`);

--
-- Indexes for table `prestasi`
--
ALTER TABLE `prestasi`
 ADD PRIMARY KEY (`id_prestasi`), ADD KEY `nik` (`nip`), ADD KEY `nip` (`nip`);

--
-- Indexes for table `sk_krj`
--
ALTER TABLE `sk_krj`
 ADD PRIMARY KEY (`no_sk`), ADD KEY `nip` (`nip`), ADD KEY `id_jabatan` (`id_jabatan`), ADD KEY `id_lokasi` (`id_lokasi`), ADD KEY `id_pangkat` (`id_pangkat`), ADD KEY `id_unit_krj` (`id_unit_krj`);
